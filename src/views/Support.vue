  ...
  <div class="p-6 space-y-8 animate-fade-in pb-20 max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      <section class="lg:col-span-2 space-y-6">
        <h3
          class="font-bold text-xl text-[var(--color-text-main)] flex items-center gap-3"
        >
        ...
        <div class="space-y-4">
          ...
          >
            ...
            >
              <span class="font-semibold text-[var(--color-text-main)]">{{
                faq.question
              }}</span>
              <component
            ...
            <transition name="expand">
              ...
              >
                <p
                  class="p-5 text-sm text-[var(--color-text-sub)] leading-relaxed bg-[var(--color-bg)]/30"
                >
                  {{ faq.answer }}
                </p>
              </div>
      ...
      <section class="space-y-6">
        <h3 class="font-bold text-xl text-[var(--color-text-main)]">
          Support direct
        </h3>

        <div
          class="bg-[var(--color-primary)] rounded-3xl p-6 text-white shadow-xl shadow-indigo-500/20 relative overflow-hidden group"
        >
          <MessageCircle
            class="absolute -right-4 -bottom-4 text-white/10 group-hover:scale-110 transition-transform"
            :size="120"
          />
        ...
        >
          ...
          <p class="text-xs text-[var(--color-text-sub)] mb-6">
            Pour les demandes complexes ou les bugs, nous vous répondons sous
            24h.
          </p>
          <button
            class="w-full py-3 border border-[var(--color-border)] text-[var(--color-text-main)] rounded-xl font-bold text-sm hover:bg-[var(--color-bg)] hover:border-[var(--color-primary)] transition-all"
          >
            Créer un ticket
          </button>
        </div>
...
useHead({
  title: "Foire aux question! FAQ - Sasaye",
  meta: [
    {
      name: "description",
      content:
        "Besoin d'aide ? Consultez notre FAQ ou contactez notre support pour une assistance rapide et efficace.",
    },
  ],
});
...
const faqs = ref([
  {
    ...
    answer:
      "Vous pouvez suivre l'état de vos services en temps réel dans votre tableau de bord Sasaye, section 'Mes Commandes'.",
    open: true,
  },
  {
    question: "Quels sont les modes de paiement acceptés au Cameroun ?",
    answer:
      "Nous acceptons Orange Money, MTN Mobile Money, ainsi que les cartes Visa et Mastercard.",
    open: false,
  },
  {
    question: "Comment sécurisez-vous mes données personnelles ?",
    answer:
      "Toutes vos données sont chiffrées via TLS 1.3 et stockées sur des serveurs sécurisés conformes au RGPD.",
    open: false,
  },
  {
    question: "Proposez-vous une API pour les développeurs ?",
    answer:
      "Oui, Sasaye dispose d'une documentation API complète pour intégrer nos solutions à vos propres applications.",
    open: false,
  },
  {
  ...
  },
  {
    ...
    answer:
      "Après validation, le remboursement est traité sous 5 à 7 jours ouvrés sur votre mode de paiement initial.",
    open: false,
  },
  {
    question: "Puis-je modifier ma commande après validation ?",
    answer:
      "Une modification est possible tant que le statut n'est pas 'En cours de traitement'. Contactez rapidement le support.",
    open: false,
  },
  {
    question: "Comment devenir partenaire Sasaye ?",
    answer:
