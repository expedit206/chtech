  ...
  >
    <header class="py-20 px-6 text-center">
      <div class="max-w-4xl mx-auto">
        <div
          class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[var(--color-primary)]/10 text-[var(--color-primary)] text-xs font-bold uppercase tracking-wider mb-6"
        >
          <Scale :size="14" /> Conformité
        </div>
    ...
    <main class="max-w-4xl mx-auto px-6 grid gap-6">
      <section
        class="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl p-8 shadow-sm"
      >
        <div class="flex items-start gap-4">
          ...
          <div class="flex-1">
            <h2 class="text-xl font-bold mb-4">Éditeur du site</h2>
            <div
              class="grid md:grid-cols-2 gap-6 text-sm text-[var(--color-text-sub)]"
            >
              <div class="space-y-2">
                <p>
                  <span
                ...
                <p>
                  <span
                    ...
                    >Siège social :</span
                  >
                  Douala,Bafoussam Cameroun
                </p>
                <p>
                  <span
                    class="font-bold text-[var(--color-text-main)] uppercase"
                    >Directeur de publication :</span
                  >
                  <a
      ...
      >
        <div class="flex items-start gap-4">
          ...
          <div class="flex-1">
            <h2 class="text-xl font-bold mb-4">Propriété Intellectuelle</h2>
            <p class="text-sm text-[var(--color-text-sub)] leading-relaxed">
      ...
      >
        <div class="flex items-start gap-4">
          <div
            class="p-3 rounded-xl bg-[var(--color-accent)]/10 text-[var(--color-accent)]"
          >
            <Info :size="24" />
          </div>
          <div class="flex-1">
            ...
            <p
              class="text-sm text-[var(--color-text-sub)] mb-4 leading-relaxed"
            >
              Pour en savoir plus sur la gestion de vos données et vos droits,
              veuillez consulter notre politique dédiée.
            </p>
            <RouterLink
              :to="{ name: 'politique_de_confidentialite' }"
              class="inline-flex items-center gap-2 text-sm font-bold text-[var(--color-primary)] hover:gap-3 transition-all"
            >
