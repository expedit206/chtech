<template>
  <div class="p-6 space-y-8 animate-fade-in pb-20">
    <header class="flex justify-between items-start">
      <div>
        <h1
          class="text-2xl font-black text-[var(--color-text-main)] font-serif tracking-tighter"
        >
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
      ...
      >
        <div
          class="flex items-center gap-3 border-b border-[var(--color-border)] pb-6"
        >
          <div
          ...
          <h3
            class="font-black text-[var(--color-text-main)] tracking-widest text-xs"
          >
        ...
        <div class="flex flex-col sm:flex-row items-center gap-8 pb-4">
          ...
          <div class="text-center sm:text-left space-y-2">
            <h4 class="font-black text-lg text-[var(--color-text-main)]">
              Photo de profil
            </h4>
            <p class="text-xs text-[var(--color-text-sub)]">
              Optimisez votre présence avec une photo réelle. JPG ou PNG
              acceptés.
            </p>
            <div class="flex gap-3 justify-center sm:justify-start">
              <button
                @click="triggerFileInput"
                class="text-xs font-black tracking-widest text-[var(--color-primary)] border-b-2 border-[var(--color-primary)] hover:opacity-70 transition-opacity pb-1"
              >
                Changer la photo
              </button>
            </div>
        ...
        <div class="space-y-6">
          <div class="grid grid-cols-1 gap-6">
            <div>
              <label
                class="block text-[10px] font-black text-[var(--color-text-sub)] tracking-[0.2em] mb-2 ml-1"
                >Nom Complet</label
              >
              <input
                type="text"
                v-model="profileForm.nom"
                class="w-full bg-[var(--color-bg)] border border-[var(--color-border)] rounded p-3 text-sm text-[var(--color-text-main)] focus:ring-2 focus:ring-[var(--color-primary)] outline-none transition-all shadow-inner"
              />
            </div>
            <div>
              <label
                class="block text-[10px] text-[var(--color-text-sub)] tracking-[0.2em] mb-2 ml-1"
                >Adresse Email</label
              >
              <input
                type="email"
          ...
          <button
            ...
            class="w-full py-4 bg-[var(--color-primary)] text-white rounded-2xl text-sm tracking-widest hover:opacity-90 transition-all flex items-center justify-center gap-2 shadow-xl shadow-primary/20 disabled:opacity-50 font-semibold"
          >
      ...
      >
        ...
        >
          ...
          <h3
            class="font-semibold text-[var(--color-text-main)] tracking-widest text-xs"
          >
            Sécurité & Accès
          </h3>
        </div>
        ...
        <div class="space-y-6">
          <p class="text-sm text-[var(--color-text-main)]">
          ...
          <div class="space-y-4">
            ...
            <button
              ...
              class="w-full py-3 bg-[var(--color-primary)] text-white rounded-xl font-semibold text-sm tracking-widest hover:opacity-90 transition-all flex items-center justify-center gap-2 shadow-pink-500/20 disabled:opacity-50"
            >
      ...
      <section class="xl:col-span-2 mt-8">
        ...
        >
          <div class="text-center md:text-left space-y-2">
            <h3 class="font-black text-red-500 text-xl tracking-tight">
              Zone de danger
            </h3>
          ...
          <button
            ...
            class="px-10 py-4 bg-red-500 text-white rounded-2xl font-black text-xs tracking-[0.2em] hover:bg-red-600 transition-all shadow-xl shadow-red-500/10"
          >
            Supprimer le compte
          </button>
        </div>
...
const updatePassword = async () => {
  ...
  try {
    ...
    alert.error({
      ...
      message:
        error.response?.data?.message || "L'ancien mot de passe est incorrect.",
    });
  } finally {
...
const confirmDeleteAccount = () => {
  alert.confirm({
    ...
    message:
      "Voulez-vous vraiment supprimer votre compte ? Toutes vos données seront effacées.",
