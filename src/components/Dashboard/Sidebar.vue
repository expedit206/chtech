  ...
  <div>
    ...
    >
      ...
      >
        ...
        <button
          @click="emit('toggle')"
          class="hidden md:block p-2 rounded-full hover:bg-[var(--color-primary)]/10 text-[var(--color-text-sub)]"
        >
          <component
    ...
    sections.push({
      ...
      items: [
        ...
        },
        {
          name: "Vendeurs",
          icon: Store,
          route: { name: "admin-users", query: { role: "vendeur" } },
        },
        {
